...
public class DesktopSystemTray {
    ...
    void createAndShowGUI() {
        ...
        showDesktopApplication.addActionListener(e -> {
            try {
                Class.forName("prizmdesktop.DesktopApplication").getMethod("launch").invoke(null);
    ...
    private void displayStatus() {
        ...
        addDataRow(statusPanel, "Application", Prizm.APPLICATION);
        addDataRow(statusPanel, "Version", Prizm.VERSION);
        ...
        addDataRow(statusPanel, "User folder", String.valueOf(Paths.get(Prizm.getUserHomeDir()).toAbsolutePath()));
        ...
        if (lastBlock != null) {
            ...
            addDataRow(statusPanel, "Seconds passed", String.valueOf(Prizm.getEpochTime() - lastBlock.getTimestamp()));
        ...
        addDataRow(statusPanel, "Process id", Prizm.getProcessId());
        addEmptyRow(statusPanel);
        ...
        if (statusDialog == null || !statusDialog.isVisible()) {
            ...
            statusDialog = pane.createDialog(wrapper, "PRIZM Server Status");
