...
public final class UnlockAccount extends UserServlet.UserRequestHandler {
    ...
    JSONStreamAware processRequest(HttpServletRequest req, User user) throws IOException {
        ...
        if (account == null) {
            ...
            try (DbIterator<? extends Transaction> transactions = Prizm.getTransactionProcessor().getAllUnconfirmedTransactions()) {
            ...
            int blockchainHeight = Prizm.getBlockchain().getLastBlock().getHeight();
            try (DbIterator<? extends Block> blockIterator = Prizm.getBlockchain().getBlocks(accountId, 0)) {
            ...
            try (DbIterator<? extends Transaction> transactionIterator = Prizm.getBlockchain().getTransactions(accountId, (byte) -1, (byte) -1, 0, false)) {
