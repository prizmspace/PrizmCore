...
public class APITestServlet extends HttpServlet {
    ...
    private static final String header1 =
            ...
            "           <a class='navbar-brand' href='/test'>PRIZM http API</a>\n" +
            "       </div>\n" +
            ...
            "               <li><a href='http://prizm-space.com' target='_blank' style='margin-left:20px;'>Wiki Docs</a></li>\n" +
            "           </ul>\n" +
            "       </div>\n" +
            "   </div>\n" +
            "</div>\n" +
    ...
    private static String form(HttpServletRequest req, String requestType, boolean singleView, APIServlet.APIRequestHandler requestHandler) {
        ...
        buf.append("<a style='font-weight:normal;font-size:14px;color:#777;' href='http://prizm-space.com");
        ...
        String formAction = "/test-proxy".equals(path) ? "/prizm-proxy" : "/prizm";
