...
public final class GetBlockchainStatus extends APIServlet.APIRequestHandler {
    ...
    protected JSONObject processRequest(HttpServletRequest req) {
        ...
        response.put("application", Prizm.APPLICATION);
        response.put("version", Prizm.VERSION);
        response.put("time", Prizm.getEpochTime());
        ...
        response.put("currentMinRollbackHeight", Prizm.getBlockchainProcessor().getMinRollbackHeight());
