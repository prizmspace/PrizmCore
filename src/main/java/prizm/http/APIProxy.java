...
public class APIProxy {
    ...
    static final boolean enableAPIProxy = Constants.isLightClient ||
            (Prizm.getBooleanProperty("prizm.enableAPIProxy") && ! API.isOpenAPI);
    private static final int blacklistingPeriod = Prizm.getIntProperty("prizm.apiProxyBlacklistingPeriod") / 1000;
    static final String forcedServerURL = Prizm.getStringProperty("prizm.forceAPIProxyServerURL", "");
    ...
    boolean blacklistHost(String host) {
        ...
        blacklistedPeers.put(host, Prizm.getEpochTime() + blacklistingPeriod);
