...
var NRS = (function(NRS, $) {
	...
	$("#set_mandatory_approval_modal").on("show.bs.modal", function(e) {
		...
		var context = {
			labelText: "Amount PRIZM",
			labelI18n: "amount_prizm",
			helpI18n: "approve_transaction_amount_help",
			inputName: "controlQuorumPRIZM",
			addonText: "PRIZM",
			addonI18n: "prizm_unit"
		}
		var $elems = NRS.initModalUIElement($modal, '.phasing_only_amount_prizm', 'simple_input_with_addon_modal_ui_element', context);
		...
		context['inputName'] = 'controlMinBalancePRIZM';
		context['addonText'] = 'PRIZM';
		context['addonI18n'] = 'prizm_unit';
		var $elems = NRS.initModalUIElement($modal, '.phasing_only_min_balance_prizm', 'simple_input_with_addon_modal_ui_element', context);
		$elems.find('input').prop("disabled", true);
		$elems.hide();
