...
var NRS = (function(NRS, $) {
    ...
    NRS.addSpacerToSidebar = function (text, position) {
      var menuHTML = '<li class="sm_simple sidemenuseparator" id="spacer_'+text+'" data-sidebar-position="' + position + '" align="center"><label style="padding-top:6px;margin-bottom:0px;">'+text+'</label></li>';
      _appendToSidebar(menuHTML, "spacer", position);
    }
