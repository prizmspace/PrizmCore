...
var NRS = (function(NRS, $) {
	var index = 0;
	var bundles = [
		{alias: "nrsVersion", status: "release", prefix: "prizm-client-", ext: "zip"},
		{alias: "nrsBetaVersion", status: "beta", prefix: "prizm-client-", ext: "zip"},
		{alias: "nrsVersionWin", status: "release", prefix: "prizm-client-", ext: "exe"},
		{alias: "nrsBetaVersionWin", status: "beta", prefix: "prizm-client-", ext: "exe"},
		{alias: "nrsVersionMac", status: "release", prefix: "prizm-installer-", ext: "dmg"},
		{alias: "nrsBetaVersionMac", status: "beta", prefix: "prizm-installer-", ext: "dmg"},
		{alias: "nrsVersionLinux", status: "release", prefix: "prizm-client-", ext: "sh"},
		{alias: "nrsBetaVersionLinux", status: "beta", prefix: "prizm-client-", ext: "sh"}
	];
	...
	NRS.downloadClientUpdate = function(status, ext) {
        ...
        var fileurl = "https://repositoriySversiyamiSoftiny/downloads/" + filename;
